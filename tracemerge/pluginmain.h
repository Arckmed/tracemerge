...
#define printfd(x, ...) _plugin_logprintf(x, __VA_ARGS__)
#define dputs(x) _plugin_logprintf("[" PLUGIN_NAME "] %s\n", x)
#define dputi(x) _plugin_logprintf("[" PLUGIN_NAME "] %i\n", x)
#define dputlu(x) _plugin_logprintf("[" PLUGIN_NAME "] %lu\n", x)
#define dputllu(x) _plugin_logprintf("[" PLUGIN_NAME "] %llu\n", x)
#define dputhex32(x) _plugin_logprintf("[" PLUGIN_NAME "] %08x\n", x)
